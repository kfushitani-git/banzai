...
export default function FaqSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "はい、全く問題ありません。この研修は「プログラミング知識ゼロ」を前提に設計されています。講師が受講者のPC画面を見ながら寄り添ってサポートするため、置いてけぼりになる心配がありません。",
    },
    {
              ...
              >
                ...
                >
                  <div className="flex items-center gap-3 pr-4">
                    <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-md bg-red-100 text-red-700 text-xs font-black">
                      Q
                    </span>
